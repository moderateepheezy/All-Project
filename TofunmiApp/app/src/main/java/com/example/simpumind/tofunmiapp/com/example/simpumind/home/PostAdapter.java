...
public class PostAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder mVHolder;
        if(convertView == null){
            convertView=mLayoutInflater.inflate(R.layout.custom_wall, parent, false);
            mVHolder=new ViewHolder();
            mVHolder.mImageView=(ImageView)convertView.findViewById(R.id.thumbnail);
