...
public class PackagingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entries.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                Intent i = new Intent(PackagingActivity.this, PackagingDetail.class);
                startActivity(i);
                return false;
            }
        });
    ...
    private void save() {
        final ProgressDialog progressDialog = new ProgressDialog(PackagingActivity.this,
        ...
        ParseObject obj = new ParseObject("Packaging");
        obj.put("packagerName", mixName);
