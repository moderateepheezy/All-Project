package org.simpumind.com.yctalumniconnect.groupchat.helper;
...
class ViewHolder {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.singleMessageContainer = (LinearLayout)convertView.findViewById(R.id.messageContainer);
        ...
        holder.userPresence.setBackgroundDrawable( // If online show the green presence dot
                this.onlineNow.contains(chatMsg.getUsername())
                        ...
                        : null);
        holder.singleMessageContainer.setBackgroundResource(chatMsg.left ? R.drawable.bubble_a : R.drawable.bubble_b);
        holder.singleMessageContainer.setGravity(chatMsg.left ? Gravity.LEFT : Gravity.RIGHT);
        return convertView;
    }
