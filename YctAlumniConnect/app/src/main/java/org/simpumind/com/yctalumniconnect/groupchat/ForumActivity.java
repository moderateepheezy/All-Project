package org.simpumind.com.yctalumniconnect.groupchat;
...
import org.simpumind.com.yctalumniconnect.activities.HomeActivity;
import org.simpumind.com.yctalumniconnect.R;
import org.simpumind.com.yctalumniconnect.groupchat.adt.ChatMessage;
import org.simpumind.com.yctalumniconnect.groupchat.callbacks.BasicCallback;
import org.simpumind.com.yctalumniconnect.groupchat.helper.ChatAdapter;
...
public class ForumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mSharedPrefs.contains(Constants.CHAT_USERNAME)){
            Intent toLogin = new Intent(this, HomeActivity.class);
            ...
            public void successCallback(String channel, Object response) {
                ...
                try {
                    ...
                    ForumActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!online)
                                Toast.makeText(ForumActivity.this, user + " is not online.", Toast.LENGTH_SHORT).show();
                            else
                                Toast.makeText(ForumActivity.this, user + " logged in since " + ChatAdapter.formatTimeStamp(loginTime), Toast.LENGTH_SHORT).show();
            ...
            public void successCallback(String channel, Object message) {
                if (message instanceof JSONObject){
                    try {
                        ...
                        final ChatMessage chatMsg = new ChatMessage(side, name, msg, time);
                        ForumActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                ...
                try {
                    ...
                    for (int i = 0; i < messages.length(); i++) {
                        try {
                            ...
                            ChatMessage chatMsg = new ChatMessage(side, name, msg, time);
                    ...
                    ForumActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ForumActivity.this, "RUNNIN", Toast.LENGTH_SHORT).show();
    ...
    public void sendMessage(View view){
        ...
        mMessageET.setText("");
        ChatMessage chatMsg = new ChatMessage(side, username, message, System.currentTimeMillis());
        side = !side;
        try {
            JSONObject json = new JSONObject();
    ...
    private class RegisterTask extends AsyncTask<Void, Void, String>{
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                if (gcm == null) {
                    gcm = GoogleCloudMessaging.getInstance(ForumActivity.this);
                }
