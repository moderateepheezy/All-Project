package org.simpumind.com.yctalumniconnect.app;
...
public class AppConst {
	...
	public static final String SDCARD_DIR_NAME = "Yabatech Alumni";

	// Picasa/Google web album username
	public static final String PICASA_USER = "moderateepheezy70";
	...
	public static List<AllMember> people = null;
